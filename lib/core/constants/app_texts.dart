class AppTexts {
  static const voterSearch = 'ভোটার তথ্য খুঁজুন';
  static const subtitle = 'আপনার ভোটার তথ্য খুঁজে বের করুন';
  static const searchType = 'খোঁজার ধরন';
  static const name = 'নাম';
  static const nameWithDob = 'নাম ও জন্ম তারিখ';
